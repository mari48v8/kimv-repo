...
#om_01 {
  background: url("http://dyrmosedesign.dk/kimvestergaard/wp-content/uploads/2019/08/plant_04-2.png");
  background-position:
    left top 30px;
...
#om_02 {
  background: url("http://dyrmosedesign.dk/kimvestergaard/wp-content/uploads/2019/08/plant_11.png");
  background-position:
    right top 30px;
  background-repeat: no-repeat;
  background-size: 70%;
 ...
 #om_03 {
  background: url("http://dyrmosedesign.dk/kimvestergaard/wp-content/uploads/2019/08/plant_03-1.png"), url('http://dyrmosedesign.dk/kimvestergaard/wp-content/uploads/2019/08/plant_08.png');
  background-position:
	...
	<div id="primary" class="content-area">
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<div class="container">
                ...
                <?php endif; ?>
				<div class="col-6 p-unik-3" id="om_01" ><?php the_field('add_content'); ?></div>
				<div class="col-6 p-unik-3 bbg"><?php the_field('add_content_two'); ?>
			
				<button id="cv-but" style="color:#fff; border:1px solid #fff; background-color:#000; margin-top: 5%;" target="_blank" onclick="window.location.href='http://dyrmosedesign.dk/Arbejdsportfolio.pdf'">Se CV</button>
				</div>
				...
				if( !empty($image) ): ?>
					...
					<img class="col-6 col-6-aaske" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
				...
				<?php endif; ?>
				<div class="col-6 p-unik-3" id="om_02"><?php the_field('add_content_three'); ?>
			  <button style="margin-top:3%;" target="_blank" onclick="window.location.href='https://www.vestergaardaesker.dk/'">wwww.vestergaardaesker.dk</button>
			  </div>
				<div class="col-9" id="om_03">
                    <h2 class="press_h2">Presse</h2>
                    <div class="col-4" style="float: left;"><div id="artikel"></div><h3 class="presse">“Århusianer glimter i Paris”</h3><button style="margin-top:3%;" target="_blank" onclick="window.location.href='https://stiften.dk/artikel/145198:Aarhus--AArhusianer-glimter-i-Paris'">Læs Artiklen</button></div>
                    <div class="col-4" style="float: left;"><div id="annonceblog"></div><h3 class="presse">“Det fineste univers af smykker”</h3><button style="margin-top:3%;" target="_blank" onclick="window.location.href='https://polishinglife.wordpress.com/tag/smykkedesigner-kim-vestergaard/'">Læs Artiklen</button></div>
                    <div class="col-4" style="float: left;"><div id="artikel"></div><h3 class="presse">“Smykkedesigner hitter i udlandet”</h3><button style="margin-top:3%;" target="_blank" onclick="window.location.href='https://stiften.dk/Portraet/Smykkedesigner-hitter-i-udlandet/artikel/146559">Læs Artiklen</button></div>
                </div>
				</div> <!-- /row -->
			</div> <!-- /container -->
		<?php endwhile; ?>
